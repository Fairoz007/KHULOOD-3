  ...
  return (
    <section className="relative min-h-screen flex">
      ...
      <div className="hidden lg:flex bg-foreground items-center justify-center w-[22%]">
        ...
        >
          <span className="text-xs tracking-[0.3em] uppercase">KHULOOD</span>
        </motion.div>
      </div>
              ...
              <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                <Link href="/contact">
                  <Button
                    size="lg"
                    variant="outline"
                    className="border-background text-background hover:bg-background/10 hover:text-background px-8 py-6 text-xs lg:text-sm tracking-[0.2em] uppercase w-full sm:w-auto"
                  >
