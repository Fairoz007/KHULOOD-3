...
export const products: Product[] = [
  ...
  {
    id: "luxury-gold-embroidery",
    name: "Golden Silk Elegance",
    price: 850.00,
    category: "Luxury Collection",
    image: "/luxury_collection_1.png",
    hoverImage: "/luxury_collection_1.png",
    description: "Exquisite golden silk abaya with intricate embroidery.",
    longDescription: "An exquisite luxury collection piece crafted from golden silk, featuring intricate hand-embroidered details and dramatic museum-quality styling.",
    materials: ["Premium Golden Silk", "Gold thread embroidery"],
    care: ["Dry clean only"],
    sizes: [{ size: "Standard", available: true }, { size: "Custom", available: true }],
    colors: [{ name: "Gold/Ivory", hex: "#D4AF37", available: true }],
    details: ["Hand-embroidered", "Museum quality", "Handcrafted in Oman"],
    madeIn: "Muscat, Oman",
  },
  {
    id: "luxury-black-velvet",
    name: "Midnight Velvet Majesty",
    price: 920.00,
    category: "Luxury Collection",
    image: "/luxury_collection_2.png",
    hoverImage: "/luxury_collection_2.png",
    description: "Majestic black velvet abaya with silver thread detailing.",
    longDescription: "A majestic addition to our luxury collection, this black velvet abaya features elaborate silver thread detailing, offering an unparalleled opulent aesthetic.",
    materials: ["Premium Velvet", "Silver thread"],
    care: ["Dry clean only"],
    sizes: [{ size: "Standard", available: true }, { size: "Custom", available: true }],
    colors: [{ name: "Black", hex: "#000000", available: true }],
    details: ["Velvet texture", "Silver detailing", "Handcrafted in Oman"],
    madeIn: "Muscat, Oman",
  },
  {
    id: "rtw-beige-crepe",
    name: "Everyday Elegance Crepe",
    price: 195.00,
    category: "Ready-to-Wear",
    image: "/ready_to_wear_1.png",
    hoverImage: "/ready_to_wear_1.png",
    description: "Contemporary minimalist everyday abaya in soft beige.",
    longDescription: "A contemporary minimalist piece designed for everyday wear. Crafted in soft beige crepe, it offers effortless elegance and exceptional comfort.",
    materials: ["Premium Crepe"],
    care: ["Dry clean recommended", "Gentle hand wash"],
    sizes: [{ size: "S", available: true }, { size: "M", available: true }, { size: "L", available: true }],
    colors: [{ name: "Beige", hex: "#F5F5DC", available: true }],
    details: ["Minimalist design", "Everyday comfort", "Handcrafted in Oman"],
    madeIn: "Muscat, Oman",
  },
  {
    id: "rtw-navy-sleek",
    name: "Modern Navy Silhouette",
    price: 215.00,
    category: "Ready-to-Wear",
    image: "/ready_to_wear_2.png",
    hoverImage: "/ready_to_wear_2.png",
    description: "Sleek modern abaya in matte navy blue with clean lines.",
    longDescription: "A sleek, modern ready-to-wear abaya in matte navy blue. Its clean lines and contemporary fit make it a versatile staple for any wardrobe.",
    materials: ["Matte Crepe Blend"],
    care: ["Dry clean recommended"],
    sizes: [{ size: "S", available: true }, { size: "M", available: true }, { size: "L", available: true }],
    colors: [{ name: "Navy Blue", hex: "#000080", available: true }],
    details: ["Clean lines", "Contemporary fit", "Handcrafted in Oman"],
    madeIn: "Muscat, Oman",
  },
  {
    id: "limited-avant-garde",
    name: "Architectural Pleats",
    price: 1200.00,
    category: "Limited Edition",
    image: "/aurora_abaya_1782932490500.png",
    hoverImage: "/aurora_abaya_1782932490500.png",
    description: "Avant-garde architectural design with striking geometric pleats.",
    longDescription: "A breathtaking limited edition avant-garde piece featuring striking geometric pleats and architectural structure. An exclusive collector's item.",
    materials: ["Structured Silk", "Organza"],
    care: ["Dry clean only"],
    sizes: [{ size: "Custom", available: true }],
    colors: [{ name: "Ivory", hex: "#FFFFF0", available: true }],
    details: ["Geometric pleats", "Avant-garde design", "Handcrafted in Oman"],
    madeIn: "Muscat, Oman",
  },
  {
    id: "limited-pearl-silk",
    name: "Pearl Cascade",
    price: 1450.00,
    category: "Limited Edition",
    image: "/noir_abaya_1782932482540.png",
    hoverImage: "/noir_abaya_1782932482540.png",
    description: "Breathtaking limited edition abaya with pearl embellishments.",
    longDescription: "Our most exclusive limited edition piece, featuring cascading pearl embellishments on flowing silk organza. Ethereal and unparalleled in luxury.",
    materials: ["Silk Organza", "Freshwater Pearls"],
    care: ["Dry clean only", "Specialist care required"],
    sizes: [{ size: "Custom", available: true }],
    colors: [{ name: "Black", hex: "#000000", available: true }],
    details: ["Pearl embellishments", "Exclusive design", "Handcrafted in Oman"],
    madeIn: "Muscat, Oman",
  },
]

export const categories = ["All", "Abayas", "Luxury Collection", "Ready-to-Wear", "Limited Edition"]
